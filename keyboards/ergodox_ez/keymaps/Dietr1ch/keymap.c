...
//|--------------+------------+------------+----------+--------------+-------+--------------'      `-------------+--------+--------+--------+--------+----------------+----------------|
  LT(FNCT,KC_GRV), KC_QUOT,     KC_LALT,       KC_LALT, GUI_T(KC_ESC),                                                     KC_RALT, KC_LBRC, KC_RBRC,  KC_BSLS,         TT(FNCT),
//`--------------+------------+------------+----------+--------------'                                                   `------------------------------------------------------------'
...
//|--------------+------------+------------+----------+--------+-------|          |      |             |--------+--------+--------+--------+------------+------------|
  KC_LSFT,         KC_Z,        KC_X,          KC_C,     KC_V,    KC_B,    KC_8,              KC_F13,      KC_N,   KC_M,   KC_COMM,  KC_DOT,  KC_SLSH,     KC_RSFT,
//|--------------+------------+------------+----------+---------+------+----------'      `-------------+--------+--------+--------+--------+------------+------------|
  KC_RCTL,         KC_Y,        KC_H,          KC_N,     KC_LALT,                                                 KC_RALT, KC_LBRC, KC_RBRC,  KC_BSLS,     MO(FNCT),
//`--------------+------------+------------+----------+---------'                                               `---------------------------------------------------'
